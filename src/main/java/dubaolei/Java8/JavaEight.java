...
public class JavaEight {
    ...
    public static void main(String[] args) {
        ...
        students.add(new Student("4", "杜六", LocalDate.of(2012, Month.MARCH, 3), 11, 42.123));
        students.add(new Student("5", "赵六", LocalDate.of(2012, Month.MARCH, 3), 10, 52.123));
        ...
        Map<Integer, Student> collect3 = students.stream().collect(Collectors.toMap(Student::getAge, Function.identity(), BinaryOperator.maxBy(Comparator.comparing(Student::getScore))));
